...
![API Setup](/static/apigw-9.png)

9) 아래와 같이 Add Permission to Lambda Function 팝업이 나타나면 [OK] 를 선택합니다.

![Permission notification](/static/apigw-10.png)

이후 아래와 같이 생성된 API 를 확인 할 수 있습니다.

![Method Execution](/static/apigw-11.png)
...
![API release](/static/apigw-14.png)
...
![Invoke URL](/static/apigw-15.png)
...
![API Gateway Log](/static/apigw-16.png)
